      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center py-4">
          ...
          <div className="hidden md:flex items-center space-x-4">
            <Button variant="ghost" className="text-purple-700 font-medium">Login</Button>
            <Button className="bg-purple-600 hover:bg-purple-700 text-white font-medium">Sign Up</Button>
          </div>
          ...
          <div className="md:hidden py-4 border-t">
            <div className="flex flex-col space-y-4">
              ...
              <div className="pt-4 flex flex-col space-y-3">
                <Button variant="ghost" className="text-purple-700 font-medium justify-start">Login</Button>
                <Button className="bg-purple-600 hover:bg-purple-700 text-white font-medium w-full">Sign Up</Button>
              </div>
            </div>
          </div>
        )}
