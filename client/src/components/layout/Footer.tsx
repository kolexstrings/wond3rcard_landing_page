    ...
    <footer className="bg-gray-900 text-white pt-16 pb-10">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-12">
          <div className="col-span-2 md:col-span-1">
            <div className="flex items-center mb-6">
              <div className="gradient-purple h-10 w-10 rounded-lg flex items-center justify-center mr-3">
                <span className="text-white font-bold">W3</span>
              </div>
              <span className="text-xl font-bold">Wond3rCard</span>
            </div>
            <p className="text-gray-400 mb-6">The modern way to share your contact information and build your network.</p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-400 hover:text-white transition duration-300">Enterprise</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-400 hover:text-white transition duration-300">API Docs</a></li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-500 mb-4 md:mb-0">&copy; {new Date().getFullYear()} Wond3rCard. All rights reserved.</p>
          <div className="flex flex-wrap justify-center items-center space-x-4">
            ...
            <span className="text-gray-700 hidden sm:inline">•</span>
            <a href="#" className="text-gray-500 hover:text-white transition duration-300">Cookie Settings</a>
          </div>
        </div>
      </div>
    </footer>
