  ...
  const features = [
    {
      ...
      description:
        "Match your card design to your brand colors, logo, and visual identity.",
      delay: 0.1,
    },
    {
      ...
      description:
        "Choose from professional, creative, or minimalist designs to suit your style.",
      delay: 0.2,
    },
    {
      ...
      title: "Rich Media",
      description:
        "Include photos, videos, and interactive elements in your digital card.",
      delay: 0.3,
    },
  ];
        ...
        <div className="flex flex-col md:flex-row gap-8 md:gap-0">
          ...
          >
            <h2 className="text-3xl sm:text-4xl font-bold mb-6">
              Design Cards That <br />
              Get Remembered
            </h2>
            <p className="text-xl text-gray-600 mb-8">
              Make a lasting impression with customizable digital business cards
