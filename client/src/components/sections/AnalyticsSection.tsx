  ...
  const features = [
    {
      ...
      title: "View Tracking",
      description: "See when and how often your card is viewed to measure your networking success.",
      delay: 0.1
    },
    {
      icon: <MousePointer className="text-white text-xl" />,
      title: "Click Analysis",
      description: "Track which links visitors click on most to understand what interests them.",
      delay: 0.2
    },
    {
      icon: <PieChart className="text-white text-xl" />,
      title: "Performance Reports",
      description: "Get detailed insights and export reports to measure your networking ROI.",
      delay: 0.3
    }
  ];
    ...
    <section className="py-20 overflow-hidden">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row">
          ...
          >
            <h2 className="text-3xl sm:text-4xl font-bold mb-6">Powerful Analytics <br/>For Your Connections</h2>
            <p className="text-xl text-gray-600 mb-8">Track engagement, measure impact, and understand how people interact with your digital card.</p>
              ...
              <div className="rounded-xl overflow-hidden shadow-2xl">
                <div className="bg-white p-4">
                  <div className="flex items-center mb-4">
                    ...
                    <div className="ml-auto text-sm font-medium px-3 py-1 bg-purple-100 text-purple-700 rounded-lg">Dashboard</div>
                  </div>
                    ...
                    <div className="bg-white border border-gray-100 rounded-lg p-3 shadow-sm">
                      <div className="flex justify-between items-start">
                        <div>
                          ...
                          <div className="text-sm text-gray-400">From all tiers</div>
                  ...
                  <div className="bg-white border border-gray-100 rounded-lg p-4 shadow-sm mb-6">
                    <div className="flex justify-between items-center mb-4">
                      ...
                      <div className="text-xs font-medium px-2 py-1 bg-purple-100 text-purple-700 rounded">This Month</div>
                    </div>
                    ...
                    <div className="h-40 relative">
                      ...
                      <div className="absolute inset-0 flex items-end">
                        {Array.from({ length: 20 }).map((_, i) => (
                          <div 
                            key={i} 
                            className={`w-1/30 ${i === 10 ? 'bg-purple-700' : 'bg-purple-200'} mx-0.5`} 
                            style={{ height: `${Math.max(10, Math.min(90, Math.random() * 100))}%` }}
                          ></div>
                        ))}
                      </div>
                      ...
                      <svg className="absolute inset-0 w-full h-full" preserveAspectRatio="none">
                        <path d="M0,120 C20,100 40,60 60,80 C80,100 100,60 120,30 C140,10 160,40 180,60 C200,80 220,30 240,50 C260,70 280,90 300,70" 
                              stroke="#6C5CE7" 
                              strokeWidth="2" 
                              fill="none"/>
                      </svg>
                    ...
                    <div className="flex flex-wrap">
                      <div className="w-2/3 pr-4">
                        <div className="flex items-center mb-2">
                          ...
                          <span className="text-xs font-medium">Users List (1,345)</span>
                        </div>
                        
                        <div className="flex space-x-2 mb-3">
                          <button className="px-2 py-1 text-xs rounded bg-gray-100 text-gray-700">All</button>
                          <button className="px-2 py-1 text-xs rounded bg-gray-100 text-gray-700">Basic</button>
                          <button className="px-2 py-1 text-xs rounded bg-gray-100 text-gray-700">Business</button>
                          <button className="px-2 py-1 text-xs rounded bg-purple-600 text-white">Premium Users</button>
                        </div>
                        
                        <div className="text-xs text-gray-400 mb-2">3rd January, 2023</div>
                      ...
                      <div className="w-1/3">
                        <div className="mb-2">
                          <div className="text-sm font-medium mb-1">Device Insight</div>
                          ...
                          <div className="w-full bg-gray-200 rounded-full h-1.5 mb-2">
                            <div className="bg-purple-600 h-1.5 rounded-full" style={{ width: '3%' }}></div>
                          </div>
                          ...
                          <div className="w-full bg-gray-200 rounded-full h-1.5 mb-2">
                            <div className="bg-purple-600 h-1.5 rounded-full" style={{ width: '1%' }}></div>
                          </div>
                        </div>
                        
                        <div className="mt-4">
                          <div className="text-sm font-medium mb-1">Subscription Trends</div>
                          ...
                          <div className="w-full bg-gray-200 rounded-full h-1.5 mb-2">
                            <div className="bg-purple-300 h-1.5 rounded-full" style={{ width: '50%' }}></div>
                          </div>
                        </div>
                      </div>
                    </div>
