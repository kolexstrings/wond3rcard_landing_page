  ...
  const features = [
    {
      ...
      description: "Let people scan your unique QR code to instantly view your digital card.",
      delay: 0.1
    },
    {
      icon: <Wifi className="text-white text-xl" />,
      title: "NFC Technology",
      description: "Tap your phone to another device to share your card wirelessly.",
      delay: 0.2
    },
    {
      icon: <Link className="text-white text-xl" />,
      title: "Direct Link Sharing",
      description: "Share your personal card link via email, text, or social media platforms.",
      delay: 0.3
    }
  ];
    ...
    <section className="py-20 bg-gray-50">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col-reverse md:flex-row">
            ...
            <div className="relative h-[500px] w-full max-w-[400px] mx-auto">
              ...
              <div className="absolute top-0 left-0 w-full max-w-sm bg-gradient-to-b from-purple-100 to-blue-50 rounded-3xl shadow-xl overflow-hidden p-6">
                ...
                <div className="bg-white rounded-2xl shadow-lg p-6 text-center">
                  ...
                  <Button size="lg" className="gradient-purple text-white font-medium w-full py-3 mb-6">
                    Preview Card
                  </Button>
                  
                  <div className="grid grid-cols-2 gap-3">
                    <Button variant="outline" size="lg" className="bg-gray-100 border-0 text-gray-700 font-medium py-3 px-2 rounded-lg">
          ...
          >
            <h2 className="text-3xl sm:text-4xl font-bold mb-6">Share Your Card <br/>Anywhere, Anytime</h2>
            <p className="text-xl text-gray-600 mb-8">Multiple sharing options make it easy to connect with anyone, even if they don't have the app.</p>
